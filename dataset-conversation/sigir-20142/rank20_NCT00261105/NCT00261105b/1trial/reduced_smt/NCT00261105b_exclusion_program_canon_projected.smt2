...
(assert (not patient_has_finding_of_healthcare_associated_infectious_disease_now))
...
(assert (not patient_is_exposed_to_telithromycin_inthepast30days))

;; Additional OR-clauses (SAT-filtered)
(assert (or patient_is_taking_ergot_alkaloid_containing_product_now patient_is_taking_pimozide_containing_product_now patient_is_taking_astemizole_containing_product_now patient_is_taking_terfenadine_containing_product_now patient_is_taking_cisapride_containing_product_now patient_is_taking_simvastatin_containing_product_now patient_is_taking_atorvastatin_containing_product_now patient_is_taking_lovastatin_containing_product_now patient_is_taking_midazolam_containing_product_in_oral_dose_form_now patient_is_taking_triazolam_containing_product_in_oral_dose_form_now patient_is_taking_alprazolam_containing_product_in_oral_dose_form_now))
