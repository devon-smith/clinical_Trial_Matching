...
(assert (not patient_has_diagnosis_of_acute_coronary_syndrome_inthehistory))
(assert (not patient_has_diagnosis_of_acute_coronary_syndrome_now))
(assert (not patient_has_diagnosis_of_acute_myocardial_infarction_inthehistory))
(assert (not patient_has_diagnosis_of_acute_myocardial_infarction_now))
